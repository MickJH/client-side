...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.createProduct = function (product) {
        var headers = this.getHeaders();
        return this.http.post(this.apiUrl + "/product/create-product", product, {
            headers: headers
        });
    };
    ...
    ProductService.prototype.getAllCars = function () {
        var headers = this.getHeaders();
        return this.http.get(this.apiUrl + "/car/all-cars", {
            headers: headers
        });
    };
    ProductService.prototype.getCarById = function (id) {
        var headers = this.getHeaders();
