...
var CarService = /** @class */ (function () {
    ...
    CarService.prototype.getAllCars = function () {
        ...
        return this.http.get(this.apiUrl + "/car/all-cars", { headers: headers });
    };
    CarService.prototype.getCarById = function (id) {
        var headers = this.getHeaders();
        return this.http.get(this.apiUrl + "/car/id/" + id, { headers: headers });
    };
    ...
    CarService.prototype.likeCar = function (id) {
        var headers = this.getHeaders();
        return this.http.post(this.apiUrl + "/user/like-car", { id: id }, { headers: headers });
    };
    CarService.prototype.getLikedCars = function () {
        var headers = this.getHeaders();
        return this.http.get(this.apiUrl + "/user/liked-cars", { headers: headers });
    };
