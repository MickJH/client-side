...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.checkEmailAvailability = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, { isAvailable: !user }];
                }
            });
        });
    };
    AuthController.prototype.register = function (userDTO) {
        return __awaiter(this, void 0, void 0, function () {
            var user, payload, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.create(userDTO)];
                    case 1:
                        user = _a.sent();
                        payload = {
                            email: user.email
    ...
    ], AuthController.prototype, "checkEmailAvailability");
    __decorate([
