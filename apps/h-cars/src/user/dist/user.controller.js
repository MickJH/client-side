    ...
    UserController.prototype.follow = function (req, body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.userService.follow(userEmail, followingUser)];
            });
        });
    };
    UserController.prototype.likeCar = function (req, body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                userEmail = req.user.email;
                carId = body.carId;
                return [2 /*return*/, this.userService.likeCar(userEmail, carId)];
            });
        });
    };
    UserController.prototype.likeProduct = function (req, body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.userService.likeProduct(userEmail, productId)];
            });
        });
    };
    __decorate([
