...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getMyProducts = function (userEmail) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productModel.find({ userEmail: userEmail }).exec()];
            });
        });
    };
    ProductService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productModel.find().exec()];
            });
        });
    };
    ProductService.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productModel.findById(id).exec()];
            });
        });
    };
    ...
    ProductService.prototype.getProductsByIds = function (productIds) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.productModel.find({ _id: { $in: productIds } }).exec()];
            });
        });
    };
